...
function search(){
    ...
    var divs = document.querySelectorAll(".catererDiv");
    // console.log(divs);
    for(let i=0;i<divs.length;i++)
    {
        let name = divs[i].querySelector("#caterer-name").innerText;
            ...
            for (var i = 0; i < data.length; i++) {
                html += `
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title" id="caterer-name" ><strong>${data[i].name}</strong></h5>
