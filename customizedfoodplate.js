function search(item) {
    console.log(item);
    let ip = document.getElementById(item).value;
    console.log(ip);
    let input = ip.toUpperCase();
    if(item=="ip1")
    {
        var divs = document.querySelectorAll(".starterDiv");
    }
    else if(item=="ip2"){
        var divs = document.querySelectorAll(".maincourseDiv");
    }
    else{
        var divs = document.querySelectorAll(".desertDiv");
    }
    // console.log(divs);
    for (let i = 0; i < divs.length; i++) {
        let name = divs[i].querySelector("#item-name").innerText;
        if (name.toUpperCase().includes(input) == true) {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (let i = 0; i < data.length; i++) {
                if (data[i].foodkind == "starter") {
                    starter +=
                        `
                        <div id="tr" class="card starterDiv" onclick="selectDiv(this)">
                ...
                if (data[i].foodkind == "maincourse") {
                    maincourse +=
                        `
                        <div id="tr" class="card maincourseDiv" onclick="selectDiv(this)">
                        <img class="card-img-top" src=${data[i].img} alt="Card image cap" loading="eager">
                        <div class="card-body">
                            <p id="item-name" >${data[i].name}<br>
                ...
                if (data[i].foodkind == "desert") {
                    desert +=
                        `
                        <div id="tr" class="card desertDiv" onclick="selectDiv(this)">
                        <img class="card-img-top" src=${data[i].img} alt="Card image cap" loading="eager">
                        <div class="card-body">
                            <p id="item-name" >${data[i].name}<br>
